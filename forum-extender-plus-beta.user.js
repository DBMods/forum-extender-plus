...
// @include http://www.techgeek01.com/dropboxext/*
// @exclude https://forums.dropbox.com/bb-admin/*
// @version 2.1.3
// @require https://ajax.googleapis.com/ajax/libs/jquery/1.10.1/jquery.min.js
// @require https://www.dropbox.com/static/api/dropbox-datastores-1.0-latest.js
// @downloadURL https://github.com/DBMods/forum-extender-plus/raw/master/forum-extender-plus-beta.user.js
// @updateURL https://github.com/DBMods/forum-extender-plus/raw/master/forum-extender-plus-beta.user.js
...
if(window.location.href == 'http://www.techgeek01.com/dropboxextplus/check-extender-plus-message.php'){
	$('.gsDropboxExtenderDeleteMsg').click(function(){
		window.location.href = 'http://www.techgeek01.com/dropboxextplus/delete-message.php?to=' + $('#header .login a[href^="https://forums.dropbox/com/profile.php"]').attr('href').split('id=')[1] + '&from=' + $(this).parent().find('form').find('input.from').val() + '&msg'
	})
}
