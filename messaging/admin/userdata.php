...
<?php
    ...
    while ($row = mysqli_fetch_assoc($result)) {
      ...
      echo '<td><form method="post" action="" style="margin:0px"><input name="dashmodpassword" id="dashmodpassword" type="password"><input name="dashuserid" id="dashuserid" type="hidden" value="' . $row['userid'] . '"> <button name="dashmodapply" id="dashmodapply" type="submit" class="button danger" value="change">Change</button></form></td>';
      echo '</tr>';
    }
?>
</table>
