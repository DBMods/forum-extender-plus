...
echo '<p><form action="messages.php" method="post"><input name="action" type="hidden" value="send"/><input name="msgto" type="textbox" style="width:100%" class="form-control" placeholder="Recipient" value="' . htmlspecialchars($_POST['to']) . '"/><br><textarea name="msgtext" placeholder="Message" rows="9" style="width:100%" class="form-control">' . htmlspecialchars($_POST['msgtext']) . '</textarea><br><button type="submit" class="btn btn-success">Send</button></form></p>';
echo '</div>';
?>
