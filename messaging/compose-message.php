...
echo '<p><form action="messages.php" method="post"><input type="hidden" name="returnto" value="' . $_POST['returnto'] . '" /><input type="hidden" name="timeOffset" value="' . $_POST['timeOffset'] . '" /><input name="action" type="hidden" value="send" /><input name="msgto" type="textbox" style="width:100%" placeholder="Recipient" value="' . $_POST['to'] . '"/><br><input name="for" type="hidden" value = "' . $userid . '"/><textarea name="msgtext" placeholder="Message" rows="9" style="width:100%">' . $_POST['msgtext'] . '</textarea><br><button type="submit">Send</button></form></p>';
echo '</div>';
?>