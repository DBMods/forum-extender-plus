...
//if ($userAuthenticated) {
	...
	if ($action == 'report') {
		...
		echo '<p>Are you sure you want to submit this report?<br><br><form action="./" method="post"><input type="hidden" name="msgto" value="TechGeek01" /><input type="hidden" name="msgtext" value="' . $_POST['report'] . '&#10;&#10;Comment:&#10;' . $_POST['comments'] . '" /><button name="action" value="send" class="btn btn-success">Yes, report this</button><button name="action" value="report" class="btn btn-danger">No, start over</button></form></p>';
	}
	echo '</p>';
//}
require 'footer.php';
