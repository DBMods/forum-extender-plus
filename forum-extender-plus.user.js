...
function navBar() {
	//Add prerequsites
	$('body').append('<div id="gsDropboxExtender-nav"><img id="gsDropboxExtenderOption-trigger" src="https://2.gravatar.com/avatar/4a62e81113e89800386a9d9aab160aee?s=420" style="height:150px;width:150px;position:fixed;bottom:-25px;left:-35px;z-index:11" /></div><div id="gsDropboxExtenderOption-popup" style="position:fixed"><a id="gsDropboxExtenderOption-close">x</a><h1>Forum Extender+ Options</h1><br/><br/><div class="left"><select name="theme"><optgroup label="Original Themes"><option value="original">Original</option><option value="8.8.2012">8.8.2012</option><option value="" selected="selected">Current Theme (No Change)</option></optgroup><optgroup label="Custom Themes"><optgroup label="-- No Existing Custom Themes --"></optgroup></optgroup></select><br/><input type="checkbox" name="collapseFooter" value="y">Auto-collapse footer</input><br><br><span id="deleteprefs">Trash Preferences</span><br><span id="deletedrafts">Trash Drafts</span></div><div class="right">Reload front page every<select name="reloadFront"><option value="0">Never</option><option value="30">30 seconds</option><option value="60">1 minute</option><option value="120">2 minutes</option><option value="300">5 minutes</option><option value="600">10 minutes</option><option value="900">15 minutes</option><option value="1800">30 minutes</option><option value="3600">1 hour</option></select><br/>Reload forum pages every<select name="reloadForum"><option value="0">Never</option><option value="30">30 seconds</option><option value="60">1 minute</option><option value="120">2 minutes</option><option value="300">5 minutes</option><option value="600">10 minutes</option><option value="900">15 minutes</option><option value="1800">30 minutes</option><option value="3600">1 hour</option></select><br/>Reload stickies every<select name="reloadSticky"><option value="0">Never</option><option value="30">30 seconds</option><option value="60">1 minute</option><option value="120">2 minutes</option><option value="300">5 minutes</option><option value="600">10 minutes</option><option value="900">15 minutes</option><option value="1800">30 minutes</option><option value="3600">1 hour</option></select><br><select id="gsDropboxExtendericon" name="modIcon"><option value="https://www.dropboxwiki.com/wp-content/uploads/static/forum-mod-icons/dropboxflat.png">Dropbox Flat</option><option value="https://www.dropboxwiki.com/wp-content/uploads/static/forum-mod-icons/dropboxflatgreen.png">Dropbox Flat Green</option><option value="https://www.dropboxwiki.com/wp-content/uploads/static/forum-mod-icons/dropboxflatlime.png">Dropbox Flat Lime</option><option value="https://www.dropboxwiki.com/wp-content/uploads/static/forum-mod-icons/dropboxflatgold.png">Dropbox Flat Gold</option><option value="https://www.dropboxwiki.com/wp-content/uploads/static/forum-mod-icons/dropboxflatorange.png">Dropbox Flat Orange</option><option value="https://www.dropboxwiki.com/wp-content/uploads/static/forum-mod-icons/dropboxflatred.png">Dropbox Flat Red</option><option value="https://www.dropboxwiki.com/wp-content/uploads/static/forum-mod-icons/dropboxflatpink.png">Dropbox Flat Pink</option><option value="https://www.dropboxwiki.com/wp-content/uploads/static/forum-mod-icons/dropboxflatpurple.png">Dropbox Flat Purple</option><option value="https://www.dropboxwiki.com/wp-content/uploads/static/forum-mod-icons/dropbox.png">Dropbox</option><option value="https://www.dropboxwiki.com/wp-content/uploads/static/forum-mod-icons/dropboxgreen.png">Dropbox Green</option><option value="https://www.dropboxwiki.com/wp-content/uploads/static/forum-mod-icons/dropboxlime.png">Dropbox Lime</option><option value="https://www.dropboxwiki.com/wp-content/uploads/static/forum-mod-icons/dropboxgold.png">Dropbox Gold</option><option value="https://www.dropboxwiki.com/wp-content/uploads/static/forum-mod-icons/dropboxorange.png">Dropbox Orange</option><option value="https://www.dropboxwiki.com/wp-content/uploads/static/forum-mod-icons/dropboxred.png">Dropbox Red</option><option value="https://www.dropboxwiki.com/wp-content/uploads/static/forum-mod-icons/dropboxpink.png">Dropbox Pink</option><option value="https://www.dropboxwiki.com/wp-content/uploads/static/forum-mod-icons/dropboxpurple.png">Dropbox Purple</option><option value="https://www.dropboxwiki.com/wp-content/uploads/static/forum-mod-icons/goldstar.png">Gold Star</option><option value="https://www.dropboxwiki.com/wp-content/uploads/static/nyancatright.gif" selected="selected">Nyan Cat (Default)</option></select><img id="gsDropboxExtendericonpreview"/><br/><input type="button" tabindex="4" value="Save" id="gsDropboxExtenderOption-save" style="clear:both;float:right;"></div>');
...
function forumVersion(versionDate) {
	...
	if (versionDate == '8.8.2012') {
		...
		$('#header').css({
			...
			'height': '174px',
			'padding': '0',
			'background': 'url(https://www.dropboxwiki.com/wp-content/uploads/static/forumsheader.jpg)'
		});
		$('.login').css({
			'float': 'left',
			'clear': 'none',
