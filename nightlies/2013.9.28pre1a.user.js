...
// @version 2013.9.28pre1a
// @require https://ajax.googleapis.com/ajax/libs/jquery/1.10.1/jquery.min.js
// @downloadURL https://github.com/DBMods/forum-mod-icons/raw/master/nightlies/2013.9.28pre1a.user.js
// @updateURL https://github.com/DBMods/forum-mod-icons/raw/master/nightlies/2013.9.28pre1a.user.js
// @grant GM_getValue
// @grant GM_setValue
...
var internalVersion = GM_info.script.version;
...
//Add footer
$('#footer').append('<div style="text-align: center; font-size: 11px; clear:both;">Dropbox Forum Mod Icons ' + versionSlug() + internalVersion + '</div>');
...
function versionSlug() {
	if(internalVersion.indexOf('pre') > -1) {
		if(internalVersion[internalVersion.length - 1] == 'a')
			return 'Nightly Build ';
		else if(internalVersion[internalVersion.length - 1] == 'b')
			return 'Beta Build ';
	} else
		return 'v';
}