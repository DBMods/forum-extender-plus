...
//Set up alerts
var alertSummary = {
	'summary': 'New reskin resulting in problems',
...
function fixNewUi(){
	...
	//Debugging
	//$('#discussions h2').css('margin-bottom', '0');
	//$('#forumlist-container').css('border', '2px solid orange');
}
...
function navBar() {
	...
	if(alertSummary){
		...
		if(alertSummary.index > GM_getValue('lastDismissedAlert', 0)){
			GM_setValue('lastDismissedAlert', alertSummary.index);
		}
		*/
