...
// @version 2013.9.14pre1a
// @require https://ajax.googleapis.com/ajax/libs/jquery/1.10.1/jquery.min.js
// @downloadURL https://github.com/DBMods/forum-mod-icons/raw/master/nightlies/2013.9.14pre1a.user.js
// @updateURL https://github.com/DBMods/forum-mod-icons/raw/master/nightlies/2013.9.14pre1a.user.js
// @grant GM_getValue
// @grant GM_setValue
// ==/UserScript==
...
highlightThread('#ffd4d4', 3); //ffc584 f79408 f78008
...
function postHighlight(highlightFor, color) {
	if(pageUrl == 'topic.php')
		if( typeof highlightFor == 'string') {
			//Count posts
			var rolePosts = $('.threadauthor p small a:contains("' + highlightFor + '")').length, totalPosts = $('.threadauthor').length;
