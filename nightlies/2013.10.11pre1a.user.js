...
var alertSummary = {
	...
	'fullDesc': 'Dropbox\'s new forum reskin has a few aesthetic bugs in it. I\'m trying to add to the script to fix this as fast as I can. In the meantime, it\'s a work in progress, and won\'t affect usability.\n\nIt looks to be fixed, but I\'m still in the process of debugging and testing the fix to make sure there are no holes. Sit tight!'
};
